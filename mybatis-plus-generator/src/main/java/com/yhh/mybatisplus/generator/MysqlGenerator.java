...
public class MysqlGenerator {
    ...
    private static String packageName="marketing.campaign";    //文件路径
    private static String authorName="Ning.Ding";     //作者
    private static String table="coupon_info";                  //table名字
    ...
    public static void main(String[] args) {
        ...
        AutoGenerator mpg = new AutoGenerator().setGlobalConfig(
                ...
                new StrategyConfig()
                        ...
                        // 自定义 controller 父类
                        .setSuperControllerClass("cn.danda."+packageName+".controller.AbstractController")
                ...
                new PackageConfig()
                        //.setModuleName("User")
                        .setParent("com.dianda."+packageName)// 自定义包路径
